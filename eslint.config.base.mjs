...
// Shared flat-config base for infinidraft/infinifaab/infinileague (and
// shared/) - identical rules in all of them, hoisted here so a rule change
// only needs to happen once. Each app's own eslint.config.js can still
// append app-specific overrides after spreading this array.
