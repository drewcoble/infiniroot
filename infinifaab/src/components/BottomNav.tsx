...
// applies to it at this generic call site - same cast infinidraft/
// infinileague's BottomNav.tsx uses for the same reason.
...
// floating-pill treatment as infinidraft/infinileague's own BottomNav.tsx.
