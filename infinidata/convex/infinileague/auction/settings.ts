...
// anti-snipe, earliest-bid-wins tiebreak. Never written on their own; only
// used to seed a real faAuctionSettings row the first time the commissioner
// opens Settings or saves a change.
...
export const getAuctionSettings = query({
  ...
  handler: async (
    ctx,
    args,
  ): Promise<Omit<Doc<"faAuctionSettings">, "_id" | "_creationTime" | "seasonId">> => {
