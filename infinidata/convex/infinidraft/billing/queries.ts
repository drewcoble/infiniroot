...
// convex/infinidraft/draft/reportCard.ts's getDraftReportCardPublic. Also surfaces
...
// Used by convex/infinidraft/billing/actions.ts (an action, which can't touch ctx.db
