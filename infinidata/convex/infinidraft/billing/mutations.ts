...
// convex/infinidraft/billing/webhookHandler.ts claims each event id before acting on it
...
// convex/lib/entitlements.ts's hasProAccess for how the two coexist.
