...
//
// Defaults to enabled (true) when unset, so local dev and the "develop"
// Vercel environment (pointing at the dev Convex deployment) need nothing
// set - only prod sets this to "false". See DEPLOY.md for the exact
// Vercel env var to set per environment.
